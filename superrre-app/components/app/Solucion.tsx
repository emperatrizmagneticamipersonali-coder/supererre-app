    ...
    <section className="py-16 sm:py-20 bg-surface-secondary">
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <div className="mt-9 text-center">
          <Link
            href="/onboarding"
            className="inline-flex items-center justify-center rounded-full border-2 border-border-strong text-txt-primary font-display font-bold text-sm px-6 py-3 hover:bg-surface-primary transition-colors"
          >
